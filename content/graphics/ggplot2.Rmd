...
Grphics are decomposed into layers. Let's begin with an empty plot with axes labeled by the data.
``` {r}
g = ggplot(mpg, aes(cty, hwy))
g
```

The *print()* can be ommitted as the *print()* method is the default for an object that is not assigned. Now actually plot some points.
``` {r}
g = ggplot(mpg, aes(cty, hwy)) +
    geom_point()
g
